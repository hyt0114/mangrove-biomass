...
require("../../utils/calculators/kandelia.js");
require("../../utils/calculators/avicennia.js");
require("../../utils/calculators/rhizophora-stylosa-griff.js");
require("../../utils/calculators/bruguiera-gymnorrhiza.js");
require("../../utils/calculators/ceriops-tagal.js");
require("../../utils/calculators/rhizophora.js");
require("../../utils/calculators/sonneratia.js");
...
if (!Array) {
  ...
  (_easycom_uni_data_picker2 + _easycom_uni_forms_item2 + _component_FormInput + _easycom_uni_forms2 + _easycom_uni_popup_dialog2 + _easycom_uni_popup2 + _easycom_uni_popup_message2)();
}
...
if (!Math) {
  (_easycom_uni_data_picker + _easycom_uni_forms_item + _easycom_uni_forms + _easycom_uni_popup_dialog + _easycom_uni_popup + _easycom_uni_popup_message)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    m: $data.formData.kind === -1 || $data.formData.kind === 9 || $data.formData.kind === 10
  }, $data.formData.kind === -1 || $data.formData.kind === 9 || $data.formData.kind === 10 ? {
    n: common_vendor.o(($event) => $data.formData.density = $event),
    o: common_vendor.p({
      suffix: "g/m3",
      value: $data.formData.density
    }),
    p: common_vendor.p({
      label: "密度",
      name: "density"
    ...
    z: $data.calcResult.hasOwnProperty("cf")
  }, $data.calcResult.hasOwnProperty("cf") ? {
    A: common_vendor.t($data.calcResult.cf)
  } : {}, {
    B: common_vendor.p({
      type: "info",
      showClose: false,
    ...
    C: common_vendor.sr("alertDialog", "1cf27b2a-9"),
    D: common_vendor.p({
      type: "dialog"
    }),
    E: common_vendor.p({
    ...
    F: common_vendor.sr("message", "1cf27b2a-11"),
    G: common_vendor.p({
      type: "message"
    })
  });
